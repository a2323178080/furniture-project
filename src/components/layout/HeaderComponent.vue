          ...
          <div class="container-fluid px-0">
            ...
            <router-link
              ...
              ><img
                ...
                alt="ICEA線上購物"
              />
              <h1 class="logo-title-hide" v-show="false">ICEA線上購物</h1>
            </router-link>
<!--            /src/assets/images/logo.png-->
            ...
            >
              <div class="row w-100 m-0">
                <div class="col-3 d-flex align-items-center" v-if="!isMobile"></div>
                <div class="col-4 d-flex justify-content-center" v-if="!isMobile">
                  <NavbarSearch v-if="!isMobile"></NavbarSearch>
                </div>
                <div class="col-12 col-lg-5 pe-0 p-0">
                  <nav class="d-flex justify-content-end w-100 h-100">
                    ...
                    >
                      <li>
                        <NavbarSearch v-if="isMobile" @toggle-open="toggleMenuOpen"></NavbarSearch>
                      </li>
                      <li
                      ...
                      >
                        ...
                        >
                          <span v-if="isMobile">{{ item.center }}</span>
                          <font-awesome-icon
                            :icon="item.icon"
                            class="header-icons"
                      ...
                      <li class="ms-4 header-navbar-items" v-if="isMobile">
                        <router-link
                          to="/member/account"
                          title="前往會員頁"
                          aria-label="member"
