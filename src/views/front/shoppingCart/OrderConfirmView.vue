            ...
            <div class="row justify-content-between align-items-center">
              <div class="col-sm-9">
                <div>
                  ...
                  <p>(期間限定：2025/01/01~2025/12/31)</p>
                </div>
              </div>
        ...
        <div class="border border-2 border-dark p-3">
          <div class="fs-5 border-bottom border-dark pb-2 mb-3">
            <div class="d-flex justify-content-between align-content-center">
              <span><font-awesome-icon :icon="['fas', 'ticket']" /> 金額計算</span>
<!--              <span-->
<!--                ><button-->
<!--                  type="button"-->
...
const userNameRegExp = /^[\u4E00-\u9FA5A-Za-z\s]+$/; // 使用 0或者+886都可以用
const schema = yup.object().shape({
  username: yup
    .string()
    .required('此欄位必填')
    .matches(userNameRegExp, { message: '請輸入有效的中文或英文姓名', excludeEmptyString: true }),
